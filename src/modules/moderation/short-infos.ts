export default {
  ...
  notr: {
    title: "Bu kanalda Türkçe konuşmayın!",
    color: "FF0000",
    aliases: ["noturkish", "turkishno"],
    description:
      "**Bu sunucunun ana dili İngilizcedir**. Herkesin sizi anlayabilmesi için bu ve diğer kanallarda İngilizce konuşabilir veya <#546016431230287892> kanalında Türkçe konuşabilirsiniz. Eğer destek amaçlı buradaysanız, <#566738846650335232> kanalına Türkçe derdinizi yazarak Türkçe yardım da alabilirsiniz.",
    footer: false,
  },
};
